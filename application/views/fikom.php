		...
		<div id="header">
			<div id="header_wrapper">
					<div id="link_wrapper">
						...
						<a href="<?php echo base_url();?>index.php/welcome/tentang">Tentang </a>
		...
		<div id="article">
			<div id="welcome">
				...
				<div class="article-con">				
					<h3>Gunadarma Masuk Dahsyat</h3>
					<center>
						<img src="<?php echo base_url();?>asset/img/berita-img.jpg" width="300px" height="200px">
						<p>lalala yeyey lalala yyee lalala alala yeyey lalala yyee lalala alala yeyey lalala yyee lalala alala yeyey lalala yyee lalalaalala yeyey lalala yyee lalala</p>
					</center>
					<a href="#">Read More</a>
				</div>
								<div class="article-con">				
